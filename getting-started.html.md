...
Using BOSH Lite and PCF Dev, you can create and manage an On-Demand Service Broker (ODB) on your local development environment. The procedures below use the following Apache Kafka examples to demonstrate how to use ODB:
